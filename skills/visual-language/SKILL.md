---
name: dxrk-memory-visual-language
description: >
  Visual language rules for Dxrk-Memory surfaces. Trigger: Any dashboard styling,
...
1. The dashboard must feel like Dxrk-Memory, not a generic SaaS admin.
