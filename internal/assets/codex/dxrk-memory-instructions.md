## Dxrk-Memory Persistent Memory — Protocol

You have access to Dxrk-Memory, a persistent memory system that survives across sessions and compactions. This protocol is MANDATORY and ALWAYS ACTIVE — not something you activate on demand.
...
Prompt capture behavior (Dxrk-Memory v1.15.3+):
...
- If an older Dxrk-Memory tool schema does not expose capture_prompt, omit the field rather than failing.
...
When completing a task or subtask, include a "## Key Learnings:" section at the end of your response with numbered items. Dxrk-Memory will automatically extract and save these.
