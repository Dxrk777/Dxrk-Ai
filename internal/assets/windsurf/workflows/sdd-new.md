...
- **Memories / MCP (Dxrk-Memory)** para recuperar contexto previo
...
1. Usar **Dxrk-Memory** mediante las herramientas MCP canónicas: `mem_search` para buscar decisiones previas y `mem_context` para recuperar el contexto reciente del proyecto
2. Si Dxrk-Memory no está disponible o no devuelve contexto suficiente, leer `AGENTS.md`
...
3. Recuperar contexto con **Dxrk-Memory** o, en su defecto, leer `AGENTS.md`
...
- Recuperó contexto con **Dxrk-Memory** o `AGENTS.md`
