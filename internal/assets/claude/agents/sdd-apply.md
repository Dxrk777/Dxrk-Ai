...
model: {{CLAUDE_MODEL}}
tools: Read, Edit, Write, Glob, Grep, Bash, mcp__plugin_dxrk-memory_dxrk-memory__mem_search, mcp__plugin_dxrk-memory_dxrk-memory__mem_get_observation, mcp__plugin_dxrk-memory_dxrk-memory__mem_save, mcp__plugin_dxrk-memory_dxrk-memory__mem_update
---
...
- capture_prompt: `false` when the Dxrk-Memory tool schema supports it; if an older schema rejects or does not expose the field, omit it rather than failing.
