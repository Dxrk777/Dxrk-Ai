...
model: {{CLAUDE_MODEL}}
tools: Read, Grep, Glob, Bash, mcp__plugin_dxrk-memory_dxrk-memory__mem_search, mcp__plugin_dxrk-memory_dxrk-memory__mem_get_observation, mcp__plugin_dxrk-memory_dxrk-memory__mem_save
---
