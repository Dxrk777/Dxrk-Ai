...
model: {{CLAUDE_MODEL}}
tools: Read, Edit, Write, Glob, mcp__plugin_dxrk-memory_dxrk-memory__mem_search, mcp__plugin_dxrk-memory_dxrk-memory__mem_get_observation, mcp__plugin_dxrk-memory_dxrk-memory__mem_save
---
