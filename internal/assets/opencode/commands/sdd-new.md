...
DXRK_MEMORY NOTE:
Sub-agents handle persistence automatically using the selected artifact store. In dxrk-memory/hybrid, each phase saves with topic_key "sdd/$ARGUMENTS/{type}".
