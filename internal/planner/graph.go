...
func MVPGraph() Graph {
	return NewGraph(map[model.ComponentID][]model.ComponentID{
		...
		model.ComponentDxrkGuardian:                nil,
		model.ComponentTheme:              nil,
		model.ComponentClaudeTheme:        nil,
		model.ComponentOpenCodeDxrkLogo: nil,
	})
}
...
// Codex) have Persona write the base file and SDD/DxrkMemory append to it. If
...
var softOrderingPairs = [][2]model.ComponentID{
	{model.ComponentPersona, model.ComponentDxrkMemory},
