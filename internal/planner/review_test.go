...
func TestBuildReviewPayloadIncludesSkills(t *testing.T) {
	...
	resolved := ResolvedPlan{
		Agents:            []model.AgentID{model.AgentClaudeCode},
		OrderedComponents: []model.ComponentID{model.ComponentDxrkMemory, model.ComponentSkills},
	}
...
func TestBuildReviewPayloadHasSDDFalseWithoutSDDComponent(t *testing.T) {
	...
	resolved := ResolvedPlan{
		Agents:            []model.AgentID{model.AgentClaudeCode},
		OrderedComponents: []model.ComponentID{model.ComponentDxrkMemory}, // no SDD
	}
