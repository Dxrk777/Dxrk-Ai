...
// Package runcell provides RunCell JupyterLab agent integration.
package runcell
...
func (a *Adapter) Agent() model.AgentID    { return model.AgentRunCell }
...
func ConfigPath(homeDir string) string {
	return filepath.Join(homeDir, ".runcell")
}
