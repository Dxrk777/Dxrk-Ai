...
// Package qodo provides Qodo (formerly Codium) testing agent integration.
package qodo
...
func (a *Adapter) Agent() model.AgentID    { return model.AgentQodo }
func (a *Adapter) Tier() model.SupportTier { return model.TierFull }

func (a *Adapter) Detect(_ context.Context, homeDir string) (bool, string, string, bool, error) {
	configPath := ConfigPath(homeDir)

	binaryPath, err := a.lookPath("qodo")
	installed := err == nil
...
func ConfigPath(homeDir string) string {
	return filepath.Join(homeDir, ".qodo")
}
