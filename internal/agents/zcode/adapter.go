...
// Package zcode provides Z.ai ZCode agent integration.
package zcode
...
func (a *Adapter) Agent() model.AgentID    { return model.AgentZCode }
func (a *Adapter) Tier() model.SupportTier { return model.TierFull }

func (a *Adapter) Detect(_ context.Context, homeDir string) (bool, string, string, bool, error) {
	configPath := ConfigPath(homeDir)

	binaryPath, err := a.lookPath("zcode")
	installed := err == nil
...
func (a *Adapter) SystemPromptFile(homeDir string) string {
	return filepath.Join(ConfigPath(homeDir), "ZCODE.md")
}
func (a *Adapter) SkillsDir(homeDir string) string {
	return filepath.Join(ConfigPath(homeDir), "skills")
}
func (a *Adapter) SettingsPath(homeDir string) string {
	return filepath.Join(ConfigPath(homeDir), "config.toml")
}
...
func ConfigPath(homeDir string) string {
	return filepath.Join(homeDir, ".zcode")
}
