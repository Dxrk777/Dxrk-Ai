...
// Package jetbrains provides JetBrains AI Assistant integration.
package jetbrains
...
func (a *Adapter) Agent() model.AgentID    { return model.AgentJetBrains }
...
func ConfigPath(homeDir string) string {
	return filepath.Join(homeDir, ".jetbrains")
}
