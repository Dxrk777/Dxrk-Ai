...
// Package amp provides Amp (Sourcegraph) agent integration.
package amp
...
func (a *Adapter) Agent() model.AgentID    { return model.AgentAmp }
func (a *Adapter) Tier() model.SupportTier { return model.TierFull }

func (a *Adapter) Detect(_ context.Context, homeDir string) (bool, string, string, bool, error) {
	configPath := ConfigPath(homeDir)

	binaryPath, err := a.lookPath("amp")
	installed := err == nil
...
func (a *Adapter) SystemPromptFile(homeDir string) string {
	return filepath.Join(ConfigPath(homeDir), "AMP.md")
}
...
func (a *Adapter) EmbeddedSubAgentsDir() string { return "amp/agents" }
func (a *Adapter) SupportsSkills() bool         { return true }
func (a *Adapter) SupportsSystemPrompt() bool   { return true }
func (a *Adapter) SupportsMCP() bool            { return true }

func ConfigPath(homeDir string) string {
	return filepath.Join(homeDir, ".amp")
}
