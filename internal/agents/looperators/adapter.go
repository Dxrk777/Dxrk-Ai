...
// Package looperators provides Looperators multi-agent loop integration.
package looperators
...
func (a *Adapter) Agent() model.AgentID    { return model.AgentLoopoperators }
...
func (a *Adapter) EmbeddedSubAgentsDir() string { return "looperators/agents" }
func (a *Adapter) SupportsSkills() bool         { return true }
func (a *Adapter) SupportsSystemPrompt() bool   { return true }
func (a *Adapter) SupportsMCP() bool            { return true }

func ConfigPath(homeDir string) string {
	return filepath.Join(homeDir, ".looperators")
}
