...
const (
	...
	actionCancel       = "Cancel"
	actionBackArrow    = "← Back"
	keyDefault         = "default"
	keyEnter           = "enter"
	profileCreateTitle = "Create SDD Profile"
...
func RenderRestoreConfirm(manifest backup.Manifest, cursor int) string {
	...
	b.WriteString(renderOptions([]string{"Restore", actionCancel}, cursor))
	b.WriteString("\n")
...
func RenderDeleteConfirm(manifest backup.Manifest, cursor int) string {
	...
	b.WriteString(renderOptions([]string{"Delete", actionCancel}, cursor))
	b.WriteString("\n")
	b.WriteString(styles.HelpStyle.Render("j/k: navigate • enter: select • esc: back"))
