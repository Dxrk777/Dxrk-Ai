...
func renderPresetList(state ClaudeModelPickerState, cursor int) string {
	...
	b.WriteString("\n")
	b.WriteString(renderOptions([]string{actionBackArrow}, cursor-len(claudePresetOrder)))
	b.WriteString("\n")
...
func renderCustomPhaseList(state ClaudeModelPickerState, cursor int) string {
	...
	b.WriteString(renderOptions([]string{"Confirm", actionBackArrow}, actionCursor))
	b.WriteString("\n")
