...
func renderCompleteSuccess(data CompletePayload) string {
	...
	if data.GGAInstalled {
		b.WriteString(styles.HeadingStyle.Render("Dxrk Guardian (per project)"))
		b.WriteString("\n")
		b.WriteString(styles.UnselectedStyle.Render("  Dxrk Guardian was installed globally."))
		b.WriteString("\n")
		b.WriteString(styles.UnselectedStyle.Render("  In each repo run: dxrk-guardian init"))
		b.WriteString("\n")
		b.WriteString(styles.UnselectedStyle.Render("  Then run: dxrk-guardian install"))
		b.WriteString("\n\n")
	}
