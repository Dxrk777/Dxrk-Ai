...
func TestPresetSelectionNextScreenFlowMatrix(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "full dxrk with opencode enters SDD mode before plugins",
			agents:     []model.AgentID{model.AgentOpenCode},
			preset:     model.PresetFullDxrk,
			wantScreen: ScreenSDDMode,
			golden:     "preset-full-dxrk-opencode-next.golden",
		},
		{
		...
		{
			name:       "full dxrk without opencode enters strict TDD",
			agents:     []model.AgentID{model.AgentCursor},
			preset:     model.PresetFullDxrk,
			wantScreen: ScreenStrictTDD,
			golden:     "preset-full-dxrk-no-opencode-next.golden",
		},
		{
...
func TestCustomPresetPostComponentFlowMatrix(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantScreen: ScreenOpenCodePlugins,
			golden:     "custom-opencode-dxrk-memory-next.golden",
		},
		{
		...
		},
		{
			...
			golden:     "custom-no-opencode-dxrk-memory-next.golden",
		},
	}
