...
func TestWriteFileAtomicReadOnlyDirRelaxesOwnerWritePermission(t *testing.T) {
	...
	if err := os.Mkdir(skillDir, 0o555); err != nil { //nolint:gosec
	...
	_, err := WriteFileAtomic(path, content, 0o600)
	if err != nil {
...
func TestWriteFileAtomicCreatesAndIsIdempotent(t *testing.T) {
	...
	first, err := WriteFileAtomic(path, content, 0o600)
	if err != nil {
	...
	second, err := WriteFileAtomic(path, content, 0o600)
	if err != nil {
...
func TestWriteFileAtomicIgnoresPermissionErrorFromSyncDirOnWindows(t *testing.T) {
	...
	result, err := WriteFileAtomic(path, content, 0o600)
	if err != nil {
