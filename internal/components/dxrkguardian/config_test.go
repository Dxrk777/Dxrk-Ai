...
func TestBuildConfig(t *testing.T) {
	...
	if !strings.HasPrefix(config, "# Dxrk Guardian Angel") {
...
func TestConfigPath(t *testing.T) {
	...
	expected := filepath.Join("/home/testuser", ".config", "dxrk-guardian", "config")
	if path != expected {
...
func TestAgentsTemplatePath(t *testing.T) {
	...
	expected := filepath.Join("/home/testuser", ".config", "dxrk-guardian", "AGENTS.md")
	if path != expected {
...
func TestFilesWritten(t *testing.T) {
	result := InjectionResult{
		ConfigFile: "/home/user/.config/dxrk-guardian/config",
		AgentsFile: "/home/user/.config/dxrk-guardian/AGENTS.md",
	}
...
func TestPostInstallMessages(t *testing.T) {
	...
	if !strings.Contains(msgs[0], "dxrk-guardian install") {
		t.Error("first message should mention dxrk-guardian install")
	}
