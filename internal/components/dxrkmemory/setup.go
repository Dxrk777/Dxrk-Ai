...
const (
	SetupModeEnvVar   = "DXRK_ENGRAM_SETUP_MODE"
	SetupStrictEnvVar = "DXRK_ENGRAM_SETUP_STRICT"
)
...
func SetupAgentSlug(agent model.AgentID) (string, bool) {
	...
	case model.AgentAntigravity:
		// Antigravity relies on Gemini's dxrk-memory setup surface; the dxrk-memory binary
	...
	case model.AgentQwenCode:
		// Qwen uses direct settings.json injection only. The dxrk-memory binary does
