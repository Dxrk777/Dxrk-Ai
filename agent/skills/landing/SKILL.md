...
license: "MIT"
metadata: {"source_spec":"megaprompts/04-landing-megaprompt.md","build_pattern":"Path B (direct conversion)","distinct_from":"product-team/skills/landing-page-generator (different output format + optimization target)","version":"1.0.0"}
---
