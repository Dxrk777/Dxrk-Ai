...
license: "MIT"
metadata: {"inspired_by":"https://github.com/ray-amjad/claude-code-workflow-creator (Ray Amjad)","targets":"Claude Code Workflow tool (CLAUDE_CODE_WORKFLOWS=1, /workflows)","version":"1.0.0"}
---
# Workflow Builder
