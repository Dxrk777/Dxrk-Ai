...
license: "MIT"
metadata: {"version":"1.0.0","build_pattern":"Path-B method skill — Cal Newport time-block discipline preserved + deterministic scheduling scripts added","distinct_from":"andreessen 3x5 card (picks WHAT to do today; deep-work plans WHEN and HOW with attention protected); project-management capacity planning (team capacity; this is one person's attention)"}
---
