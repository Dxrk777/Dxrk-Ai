...
license: "MIT"
metadata: {"source_spec":"megaprompts/07-inbox-triage-megaprompt.md","build_pattern":"Path B (direct conversion)","paired_with":"inbox-setup (consumes the 7-file KB it produces)","version":"1.0.0"}
---
