...
license: "MIT"
metadata: {"derived_from":"https://github.com/mattpocock/skills/tree/main/skills/engineering/grill-with-docs","original_author":"Matt Pocock (@mattpocock)","original_license":"MIT","voice":"Matt Pocock — relentless, one-at-a-time, codebase-and-docs-first, ADRs only when 3 criteria are met","version":"1.0.0"}
---
# Grill with Docs
