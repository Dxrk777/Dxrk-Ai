...
license: "MIT"
metadata: {"version":"1.0.0","build_pattern":"Persona skill — verbatim operating prompt + Andreessen canon","inspired_by":"Marc Andreessen (a16z); custom operating prompt supplied by user"}
---
