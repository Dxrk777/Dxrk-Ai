...
|---|---|---|
| `cmd/dxrk/` | Binary entrypoint and version handoff. | Business rules or file mutation logic. |
...
| `internal/state/` | `~/.dxrk/state.json` persisted install selections. | Dxrk-Memory memory state. |
...
| Change Dxrk-Memory setup | `internal/components/dxrk-memory/` | `docs/dxrk-memory.md`, `internal/assets/*/dxrk-memory-*` |
