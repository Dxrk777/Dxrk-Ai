...
Every time you run `dxrk install`, `sync`, or `upgrade`, the system:
...
1. Run `dxrk` and navigate to the **Backups** screen
...
2. Restore from latest snapshot via the TUI or `dxrk restore latest`
